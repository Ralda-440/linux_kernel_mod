...
asmlinkage long sys_use_mem(unsigned long __user *_info);
asmlinkage long sys_use_swap(unsigned long __user *_info);
asmlinkage long sys_fault_pages(unsigned long __user *_info);
asmlinkage long sys_use_pages(unsigned long __user *_info);
asmlinkage long sys_use_mem_top_procs(void __user *_info);
